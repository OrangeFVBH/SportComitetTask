...
def init_db():
    ...
    if cursor.fetchone()[0] == 0:  # Если таблица пуста
        initial_sections_data = [
            ...
            {"org_name": "Атлант", "leader": "Петров Сергей Петрович", "address": "пр. Октября, 52",
             "phone": "89170001122", "city": "Уфа", "sports": "Плавание;Волейбол", "schedule": "Сб-Вс 10:00-15:00",
             "age_groups": "10-18 лет"},
            {"org_name": "Грация", "leader": "Сидорова Анна Павловна", "address": "ул. Мира, 10",
             "phone": "89873334455", "city": "Москва", "sports": "Гимнастика;Танцы",
             "schedule": "Пн, Ср, Пт 15:00-20:00", "age_groups": "5-12 лет"},
